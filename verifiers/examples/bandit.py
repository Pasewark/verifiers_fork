...
inference:
CUDA_VISIBLE_DEVICES=0,1 NCCL_P2P_DISABLE=1 vf-vllm --model willcb/Qwen3-1.7B --data-parallel-size 2
training:
CUDA_VISIBLE_DEVICES=2,3 NCCL_P2P_DISABLE=1 accelerate launch --num-processes 2 --config-file configs/zero3.yaml verifiers/examples/bandit.py"""
...
training_args.max_completion_length=1024*5
